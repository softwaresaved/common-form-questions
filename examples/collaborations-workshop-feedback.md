...
### Question:
```
How would you rate the mini-workshop you attended in the second session?
```
...
### Question:
```
How would you rate the mini-workshop you attended in the third session?
```
...
### Question:
```
Please rate the Collaborative Ideas session
```
...
### Question:
```
Please rate the panel Q&A on sustainable software practice
```
...
### Question:
```
Please rate the conference dinner
```
...
### Question:
```
Please rate the social programme (please answer if you took part in any or all of the City Tour, Morning Tour or Outdoors Time)
```      
...
### Question:
```
Did you find the help you were looking for at the workshop?
```      
...
#### Answer-Choices:
* Yes - comprehensive help
* Yes - some help
* No - but some related information was useful
* No - not at all
* N/A - I did not need any particular help/advice about research software related matters

### Question:
```
How many new people did you meet at the workshop?
```      
...
### Question:
```
How many collaborations did you start, or intend to start, based on conversations from the workshop?
```      
...
### Question:
```
Do you have any recommendations or suggestions for improving the workshop
```      
...
## Section:
Your experience of the CW Hackday

### Question:
```
How useful and enjoyable was the Hackday
```      
...
### Question:
```
During the hackday, did you mainly work on developing code, or did you mainly work in a non-coding role?
```      
